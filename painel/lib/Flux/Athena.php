...
class Flux_Athena {	
	...
	* Por exemplo, 100 significa que é 1 x oficial taxas 100%.
	...
	/**
	 * Taxa de drop. $expRates mesmas regras se aplicam.
	 *
	 * @access public
	 * @var int
	 */
	 ...
	 * @access public
	 */
	public function __construct(Flux_Config $charMapConfig, Flux_LoginServer $loginServer, Flux_CharServer $charServer, Flux_MapServer $mapServer, Flux_GameDatabase $gameDatabase)
	{
		...
		$this->gameDatabase	   = $gameDatabase->config->getDatabase();
