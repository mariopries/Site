...
$skillDB    = "{$server->gameDatabase}.mobskills";
$fromTables = array("{$server->gameDatabase}.mob_skill_db", "{$server->gameDatabase}.mob_skill_db2");
...
$itemDB    = "{$server->gameDatabase}.items";
