...
return array(
	...
	'SiteTitle'            => 'Painel de Controle',		// This value is only used if the theme decides to use it.
	...
	'MailerSMTPHosts'      => 'nuvem34br.hoteldaweb.com.br',                     // When MailerUseSMTP is true: A string host or array of hosts (e.g., 'host1' or array('host1', 'backuphost')).
	'MailerSMTPUsername'   => 'no-reply@cobrasil.net',                     // When MailerUseSMTP is true: Authorized username for SMTP server.
	'MailerSMTPPassword'   => 'O@DTR$D0PV+oQmQFOc',                     // When MailerUseSMTP is true: Authorized password for SMTP server (for above user).
