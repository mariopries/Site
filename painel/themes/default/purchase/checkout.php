...
<table class="vertical-table cart">
	...
	<form action="<?php echo $this->url ?>" method="post">
		...
		<button style=" font-size:12px; color:#CCC; text-transform:uppercase; font:Verdana, Geneva, sans-serif; border: #393 solid 10px; border-radius: 3px; margin-top:20px; background-color:#393;" type="submit" onclick="return confirm('Você deseja continuar com a compra desse(s) item(s)?')">Comprar / Confimar Itens</button>
	</form>
